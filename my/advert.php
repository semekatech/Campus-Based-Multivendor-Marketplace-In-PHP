...
if(isset($_POST['promote']))
	{
$pid=$_POST['id'];
$select="select * from tblproducts where id='$pid'";
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form validate-form" action="" method="post">
					...
					<h5>Product Price:<?php echo htmlentities(number_format($price));?> Ksh.</h5>
<p>Promoting this product will have the following advantages:</p
<ul>
    <li>- Listed in Shopcampus Homepage with <b>featured</b> tag.</li>
    <li>- Listed On top of other items in all products pages.</li>
    <li>- Appear on top of every search query.</li>
    <li>- Shared to Social Media sites.</li>
</ul>
<p>To Promote this product,follow the Following procedure</p>
<ul>
    <li>- Go to Mpesa Menu</li>
     <li>- Choose Lipa Na Mpesa</li>
     <li>- Enter <b>5843867</b> As Business Number(Till No)</li>
    <li>- Enter 50 Ksh as Amount</li>
    <li>- After Payment Enter The transaction code e.g <b>PXLO3SS</b> below and also forward the payment message to <b>0705030613</b></li>
    <li>- After the payment is verified,the product will appear as featured.</li>
</ul>
...
$code=$_POST['code'];
$status='Pending';
$sql ="SELECT code FROM promted_products WHERE code=:code";
...
if($query->rowCount() >0)
{
echo "<script>alert('Transaction Code Already Used'); window.location='manage-ads.php'</script>";
} else{
$sql="INSERT INTO promted_products(code,phone,product_id,user,status) 
...
if($lastInsertId)
{
echo "<script>alert('Submitted For Verification.'); window.location='manage-ads.php'</script>";
}
else 
{
