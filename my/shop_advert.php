...
if(isset($_POST['promote']))
	{
$pid=$_POST['id'];
$select="select * from tblbusiness where id='$pid'";
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form validate-form" action="" method="post">
					...
					<h5>Business Name: <?php echo $name; ?></h5>
				
<p>Promoting this Business will have the following advantages:</p>
<ul>
    <li>- Listed in Shopcampus Homepage with <b>featured</b> tag.</li>
    <li>- Listed On top of other businesses.</li>
    <li>- Appear on top of every search query.</li>
    <li>- Shared to Social Media sites.</li>
</ul>
<p>To Promote this business,follow the Following procedure</p>
<ul>
    ...
    <li>- After the payment is verified,the business will abe promoted.</li>
...
$code=$_POST['code'];
$status='Pending';
$sql ="SELECT code FROM promoted_shops WHERE code=:code";
...
$sql="INSERT INTO promoted_shops(code,phone,shop_id,user,status) 
...
if($lastInsertId)
{
echo "<script>alert('Submitted For Verification.'); window.location='manage-business.php'</script>";
}
else 
{
    echo "<script>alert('Something went wrong. Please try again.'); window.location='manage-business.php'</script>";
}
