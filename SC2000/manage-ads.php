...
$sql="SELECT * FROM tblproducts WHERE state='1'";
...
{
$s=$_POST['id'];
$sus="UPDATE `tblproducts` SET `state`='0' WHERE `id`='$s'";
$query=mysqli_query($conn,$sus);
if($conn->query($sus)===TRUE);
{
echo "<script>alert('Ad Suspended Successfully!'); window.location='manage-ads.php'</script>";
}}?>                                                              </tbody>
                                                </table>
