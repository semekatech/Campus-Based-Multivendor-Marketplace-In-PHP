                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Manage Featured Stores</li>
            						</ul>
                                </div>
...
<tr>
 <td><?php echo $counter;?></td>
      ...
      <form method="post">
        ...
        <button name="delete" type="submit" style="border:none; background-color:transparent;"  name="depromote"><i class="fa fa-eye-slash"></i></button>
      </form></td>
</tr>
 <?php
		$counter++;
...
if($conn->query($sus)===TRUE);
{
    ?>
      <script>
        alert('Success!'); window.location='manage-featured-stores.php'
      </script>
    <?php
}}?>                                        </tbody>
                                                </table>
