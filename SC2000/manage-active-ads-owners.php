                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Users With Ads</h2>
                                </div>
...
$sql="SELECT DISTINCT PostBy FROM tblproducts";
...
$owner=$row3["FullName"];
$conts=$row3["ContactNo"];
$pro = "SELECT count(id) as num FROM tblproducts WHERE PostBy='$email'";
...
<tr>
 <td><?php echo $counter;?></td>
                                                            <td><?php echo htmlentities($row3["FullName"])?></td>
                                                             <td><?php echo htmlentities($email)?></td>
                                                              <td><?php echo htmlentities($conts)?></td>
