                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">ShopCampus Users</h2>
                                </div>
...
$sql="SELECT * FROM tblshops WHERE promoted='Yes";
...
<tr>
 <td><?php echo $counter;?></td>
      ...
      <form method="post">
        ...
        <button name="delete" type="submit" style="border:none; background-color:transparent;"  name="delete"><i class="fa fa-eye-slashed"></i></button>
      </form></td>
</tr>
 <?php
		$counter++;
